...
?>
    ...
    <div class="services">
      ...
      >
        ...
        <path
          class="grain__path"
          fill-opacity="1"
          d="M0,192L80,202.7C160,213,320,235,480,213.3C640,192,800,128,960,112C1120,96,1280,128,1360,144L1440,160L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"
        ></path>
      </svg>
        ...
        <div class="container">
          <div class="row justify-content-evenly">
            ...
            <div class="col-xl-6 col-md-6">
              <div
                class="card border border-2 mb-3 p-3"
        ...
        <div class="swiper02">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <img
                class="guillemets guillemets--up"
                src="<?php echo get_template_directory_uri(); ?>/images/guillemetsvf.png"
              />
              <div class="bloc">
              ...
              <img
                class="guillemets guillemets--down"
                src="<?php echo get_template_directory_uri(); ?>/images/guillemetsvf.png"
              />
              <div class="temoin">
    ...
    <div class="nouvelles">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path
          class="nouvelles__path"
          fill-opacity="1"
          d="M0,128L48,149.3C96,171,192,213,288,229.3C384,245,480,235,576,229.3C672,224,768,224,864,208C960,192,1056,160,1152,154.7C1248,149,1344,171,1392,181.3L1440,192L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
        ></path>
      </svg>
    ...
    <div class="donation">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        ...
        <path
          class="grain__path"
          fill-opacity="1"
          d="M0,192L60,170.7C120,149,240,107,360,112C480,117,600,171,720,176C840,181,960,139,1080,112C1200,85,1320,75,1380,69.3L1440,64L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"
        ></path>
      </svg>
